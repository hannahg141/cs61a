...
;;; SPECIFIC user defined procedures and special forms

(define water (mu (ice) (- ice lemon)))
(define soda (lambda (ice lemon) (water (+ ice ice))))
(soda 11 19)
; expect 3

(define (my-test hannah rocks)
  (if (> hannah rocks) 100 0))
; expect my-test
...
(define (icecream chocolate vanilla)
  (if (and (< (* chocolate vanilla) 100) (> (+ chocolate 5) 10)) 'cowabunga 'loser
  ) 
)
; expect icecream
...
(append (reverse '(3 2 1)) (reverse (reverse '(4 5 6))))
; expect (1 2 3 4 5 6)

;;;note that the code for compose and apply-twice was borrowed from the tests below!!

(define compose (lambda (f g) (lambda (x) (f (g x)))))
((compose reverse reverse) '(1 2 3))
; expect (1 2 3)
...
(define (print-reduce-print z)
  (print z)
  (- z 1)
  (print z)
)
; expect print-reduce-print
(print-reduce-print 6)
; expect 6 ; 6

((apply-twice print-reduce-print) 5)
; expect Error

(define (meaning-of-life a)
  (if (< a 42)
    'fish
    (if (= a 42)
      42
